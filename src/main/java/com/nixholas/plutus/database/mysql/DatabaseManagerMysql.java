...
public class DatabaseManagerMysql implements DatabaseManagerInterface {
    ...
    public DatabaseManagerMysql(PlutusCore plutusCore) {
    ...
    public boolean setupDatabase() {
        try {
            ...
            dbHost = plutusCore.getConfigurationHandler().getString("database.mysql.host");
            dbPort = plutusCore.getConfigurationHandler().getString("database.mysql.port");
            database = plutusCore.getConfigurationHandler().getString("database.mysql.databaseName");
            dbUser = plutusCore.getConfigurationHandler().getString("database.mysql.user");
            dbPassword = plutusCore.getConfigurationHandler().getString("database.mysql.password");
        ...
        PlutusCore.log.info("Mysql has been set up!");
        return true;
    }
