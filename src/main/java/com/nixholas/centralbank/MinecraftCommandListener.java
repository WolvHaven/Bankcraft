...
public class MinecraftCommandListener implements CommandExecutor {
    ...
    public void sendHelp(Player p) {
        ...
        if (CentralBank.perms.has(p, "Centralbank.command.version") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.version") + " Shoes the current version of Centralbank.");
        if (CentralBank.perms.has(p, "Centralbank.command.balance") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.balance") + " PLAYER Shows your banked money.");
        if (CentralBank.perms.has(p, "Centralbank.command.balancexp") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.balancexp") + " PLAYER Shows your banked XP.");
        if (CentralBank.perms.has(p, "Centralbank.command.deposit") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.deposit") + " AMOUNT Deposits money to your Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.withdraw") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.withdraw") + " AMOUNT Withdraws money from your Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.depositxp") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.depositxp") + " AMOUNT Deposits XP to your Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.withdrawxp") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.withdrawxp") + " AMOUNT Withdraws XP from your Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.transfer") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.transfer") + " PLAYER AMOUNT Transfers money to another Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.transferxp") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.transferxp") + " PLAYER AMOUNT Transfers XP to another Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.interesttimer") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.interesttimer") + " Shows the remaining time until the next wave of interests.");
        if (CentralBank.perms.has(p, "Centralbank.command.exchange") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.exchange") + " AMOUNT Exchanges money to XP.");
        if (CentralBank.perms.has(p, "Centralbank.command.exchangexp") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.exchangexp") + " AMOUNT Exchanges XP to money.");
        if (CentralBank.perms.has(p, "Centralbank.command.rankstats") || CentralBank.perms.has(p, "Centralbank.command"))
            p.sendMessage("/bank " + coHa.getString("signAndCommand.rankstats") + " Shows the richest players.");
        if (CentralBank.perms.has(p, "Centralbank.command.rankstatsxp") || CentralBank.perms.has(p, "Centralbank.command"))
    ...
    public void sendAdminHelp(Player p) {
        ...
        if (CentralBank.perms.has(p, "Centralbank.command.set") || CentralBank.perms.has(p, "Centralbank.command.admin"))
            p.sendMessage("/bankadmin " + coHa.getString("signAndCommand.admin.set") + " PLAYER AMOUNT Sets a players money.");
        if (CentralBank.perms.has(p, "Centralbank.command.setxp") || CentralBank.perms.has(p, "Centralbank.command.admin"))
            p.sendMessage("/bankadmin " + coHa.getString("signAndCommand.admin.setxp") + " PLAYER AMOUNT Sets a players XP.");
        if (CentralBank.perms.has(p, "Centralbank.command.grant") || CentralBank.perms.has(p, "Centralbank.command.admin"))
            p.sendMessage("/bankadmin " + coHa.getString("signAndCommand.admin.grant") + " PLAYER AMOUNT Grants a Player money.");
        if (CentralBank.perms.has(p, "Centralbank.command.grantxp") || CentralBank.perms.has(p, "Centralbank.command.admin"))
            p.sendMessage("/bankadmin " + coHa.getString("signAndCommand.admin.grantxp") + " PLAYER AMOUNT Grants a player XP.");
        if (CentralBank.perms.has(p, "Centralbank.command.clear") || CentralBank.perms.has(p, "Centralbank.command.admin"))
            p.sendMessage("/bankadmin " + coHa.getString("signAndCommand.admin.clear") + " PLAYER Clears money from a players Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.clearxp") || CentralBank.perms.has(p, "Centralbank.command.admin"))
            p.sendMessage("/bankadmin " + coHa.getString("signAndCommand.admin.clearxp") + " PLAYER Clears XP from a players Account.");
        if (CentralBank.perms.has(p, "Centralbank.command.databaseimport") || CentralBank.perms.has(p, "Centralbank.command.admin"))
        ...
        if (CentralBank.perms.has(p, "Centralbank.command.reloadconfig") || CentralBank.perms.has(p, "Centralbank.command.admin"))
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String cmdlabel, final String[] vars) {
        ...
        if (sender instanceof Player) {
            ...
            if (cmdlabel.equalsIgnoreCase("bank") || cmdlabel.equalsIgnoreCase("bc")) {
                ...
                if (vars.length == 1) {
                    ...
                    if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.version"))) {
                        p.sendMessage("This server uses Centralbank " + centralBank.getDescription().getVersion());
                        return true;
                    }

                    if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.balance")) && (CentralBank.perms.has(p, "Centralbank.command.balance") || CentralBank.perms.has(p, "Centralbank.command"))) {
                        return centralBank.getInteractionHandler().interact(vars[0], "", p, p.getUniqueId());
                    }
                    if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.balancexp")) && (CentralBank.perms.has(p, "Centralbank.command.balancexp") || CentralBank.perms.has(p, "Centralbank.command"))) {
                        return centralBank.getInteractionHandler().interact(vars[0], "", p, p.getUniqueId());
                    }

                    if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.interesttimer")) && (CentralBank.perms.has(p, "Centralbank.command.interesttimer") || CentralBank.perms.has(p, "Centralbank.command"))) {
                        return centralBank.getInteractionHandler().interact(vars[0], "", p, p.getUniqueId());
                    }

                    if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.rankstats")) && (CentralBank.perms.has(p, "Centralbank.command.rankstats") || CentralBank.perms.has(p, "Centralbank.command"))) {
                        return centralBank.getInteractionHandler().interact(vars[0], "", p, p.getUniqueId());
                    }

                    if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.rankstatsxp")) && (CentralBank.perms.has(p, "Centralbank.command.rankstatsxp") || CentralBank.perms.has(p, "Centralbank.command"))) {
                        return centralBank.getInteractionHandler().interact(vars[0], "", p, p.getUniqueId());
                    }
                }
                if (vars.length == 2) {
                    if (Util.isPositive(vars[1]) || vars[1].equalsIgnoreCase("all")) {
                        if (vars[0].equalsIgnoreCase("add") && (CentralBank.perms.has(p, "Centralbank.admin"))) {
                        ...
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.balance")) && (CentralBank.perms.has(p, "Centralbank.command.balance.other") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            ...
                            return true;
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.balancexp")) && (CentralBank.perms.has(p, "Centralbank.command.balancexp.other") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                                    centralBank.getInteractionHandler().interact(vars[0], "", p, centralBank.getUUIDHandler().getUUID(vars[1], p));
                                }
                            ...
                            return true;
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.deposit")) && (CentralBank.perms.has(p, "Centralbank.command.deposit") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                            ...
                            return true;
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.withdraw")) && (CentralBank.perms.has(p, "Centralbank.command.withdraw") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                                    centralBank.getInteractionHandler().interact(vars[0], vars[1], p, p.getUniqueId());
                                }
                            ...
                            return true;
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.depositxp")) && (CentralBank.perms.has(p, "Centralbank.command.depositxp") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                                    centralBank.getInteractionHandler().interact(vars[0], vars[1], p, p.getUniqueId());
                                }
                            ...
                            return true;
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.withdrawxp")) && (CentralBank.perms.has(p, "Centralbank.command.withdrawxp") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                                    centralBank.getInteractionHandler().interact(vars[0], vars[1], p, p.getUniqueId());
                                }
                            ...
                            return true;
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.exchange")) && (CentralBank.perms.has(p, "Centralbank.command.exchange") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                                    centralBank.getInteractionHandler().interact(vars[0], vars[1], p, p.getUniqueId());
                                }
                            ...
                            return true;
                        } else if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.exchangexp")) && (CentralBank.perms.has(p, "Centralbank.command.exchangexp") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                                    centralBank.getInteractionHandler().interact(vars[0], vars[1], p, p.getUniqueId());
                                }
                        ...
                        if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.balance")) && (CentralBank.perms.has(p, "Centralbank.command.balance.other") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                ...
                if (vars.length == 3) {
                    if (Util.isPositive(vars[2]) || vars[2].equalsIgnoreCase("all")) {
                        if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.transfer")) && (CentralBank.perms.has(p, "Centralbank.command.transfer") || CentralBank.perms.has(p, "Centralbank.command"))) {
                            final double amount;
                            ...
                            if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.transferxp")) && (CentralBank.perms.has(p, "Centralbank.command.transferxp") || CentralBank.perms.has(p, "Centralbank.command"))) {
                ...
                if (cmdlabel.equalsIgnoreCase("bankadmin") || cmdlabel.equalsIgnoreCase("bcadmin")) {
                    if (vars.length == 0) {
                        ...
                        if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.reloadconfig")) && (CentralBank.perms.has(p, "Centralbank.command.reloadconfig") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
                            centralBank.reloadConfig();
                            p.sendMessage(coHa.getString("chat.color") + coHa.getString("chat.prefix") + "Config reloaded!");
                            return true;
                        }
                    } else if (vars.length == 2) {
                        if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.clear")) && (CentralBank.perms.has(p, "Centralbank.command.clear") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                        ...
                        if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.clearxp")) && (CentralBank.perms.has(p, "Centralbank.command.clearxp") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
                            CentralBank.execService.submit(new Runnable() {
                                public void run() {
                        ...
                        if (Util.isDouble(vars[2])) {
                            if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.set")) && (CentralBank.perms.has(p, "Centralbank.command.set") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
                                CentralBank.execService.submit(new Runnable() {
                                    public void run() {
                            ...
                            if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.setxp")) && (CentralBank.perms.has(p, "Centralbank.command.setxp") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
                                CentralBank.execService.submit(new Runnable() {
                                    public void run() {
                            ...
                            if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.grant")) && (CentralBank.perms.has(p, "Centralbank.command.grant") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
                                CentralBank.execService.submit(new Runnable() {
                                    public void run() {
                            ...
                            if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.grantxp")) && (CentralBank.perms.has(p, "Centralbank.command.grantxp") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
                                CentralBank.execService.submit(new Runnable() {
                                    public void run() {
                            ...
                            if (vars[0].equalsIgnoreCase(coHa.getString("signAndCommand.admin.databaseimport")) && (CentralBank.perms.has(p, "Centralbank.command.databaseimport") || CentralBank.perms.has(p, "Centralbank.command.admin"))) {
            ...
            CentralBank.log.info("[Centralbank] Please use this ingame!");
        }
